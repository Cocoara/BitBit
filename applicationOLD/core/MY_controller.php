...
require APPPATH . '/helpers/jwt/BeforeValidException.php';
require APPPATH . '/helpers/jwt/ExpiredException.php';
require APPPATH . '/helpers/jwt/SignatureInvalidException.php';
